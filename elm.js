...
var $author$project$Sandbox$init = {showDetails: true};
...
var $author$project$Sandbox$update = F2(
	function (msg, model) {
		return model.showDetails ? _Utils_update(
			model,
			{showDetails: false}) : _Utils_update(
			model,
			{showDetails: true});
	});
var $author$project$Sandbox$ToggleDetails = {$: 'ToggleDetails'};
...
var $author$project$Sandbox$viewPhotoAndDetails = F3(
	function (model, source, description) {
		return model.showDetails ? A2(
			$elm$html$Html$div,
			_List_Nil,
			_List_fromArray(
				[
					...
					$elm$html$Html$text('Source: ' + source)
				])) : A2(
			$elm$html$Html$div,
			_List_Nil,
			_List_fromArray(
			...
			[
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text('Food gallery')
									]))
							]))
					])),
				A2(
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Events$onClick($author$project$Sandbox$ToggleDetails)
									]),
								_List_fromArray(
									[
										$elm$html$Html$text('Toggle details')
									]))
							]))
					])),
				A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								A3($author$project$Sandbox$viewPhotoAndDetails, model, 'https://images.immediate.co.uk/production/volatile/sites/30/2020/08/gnocchi-1d16725.jpg?quality=90&resize=440,400', 'Chorizo & mozzarella gnocchi bake')
							])),
						A2(
						$rundis$elm_bootstrap$Bootstrap$Grid$col,
						_List_Nil,
						_List_fromArray(
							[
								A3($author$project$Sandbox$viewPhotoAndDetails, model, 'https://images.immediate.co.uk/production/volatile/sites/30/2020/08/one-pan-spaghetti-with-nduja-fennel-olives-2308fb3.jpg?quality=90&webp=true&resize=300,272', 'One-pan spaghetti with nduja, fennel & olives')
							])),
						A2(
						$rundis$elm_bootstrap$Bootstrap$Grid$col,
						_List_Nil,
						_List_fromArray(
							[
								A3($author$project$Sandbox$viewPhotoAndDetails, model, 'https://images.immediate.co.uk/production/volatile/sites/30/2020/08/easy-chicken-curry-aa22a0b.jpg?quality=90&webp=true&resize=300,272', 'Easy chicken curry')
							]))
					]))
			]));
};
var $author$project$Sandbox$main = $elm$browser$Browser$sandbox(
